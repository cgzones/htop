...
#define RichString_setChar(this, at, ch) do { (this)->chptr[(at)] = (chtype)ch; } while (0)
#endif
...
size_t RichString_appendnWideColumns(RichString* this, int attrs, const char* data, size_t len, size_t* columns);
